...
H2_PORT="${H2_PORT:-8843}"
H1_PORT="${H1_PORT:-8845}"

H2_URL="https://127.0.0.1:${H2_PORT}/echo"
H1_URL="https://127.0.0.1:${H1_PORT}/echo"
TEST_BIN="${BUILD_DIR}/request_transport_test"
